        ...
        <div>
            <Calendar
                ...
                tileContent={({ date, view }) => { 
                    ...
                    if (props.goodDays.find((x) => x === moment(date).format("YYYY-MM-DD"))) {
                        html.push(<div className="goodDot"></div>);
                    } else if (props.normalDays.find((x) => x === moment(date).format("YYYY-MM-DD"))) {
                        html.push(<div className="normalDot"></div>);
                     }
                    else if (props.badDays.find((x) => x === moment(date).format("YYYY-MM-DD"))) {
