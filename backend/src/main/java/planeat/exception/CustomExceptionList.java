...
public enum CustomExceptionList {
    ...
    USER_REC_INTAKE_NOT_FOUND_ERROR(HttpStatus.NOT_FOUND,"E010", "존재하지 않는 유저 권장 섭취량입니다."),
    USER_CATEGORY_INFO_NOT_FOUND_ERROR(HttpStatus.NOT_FOUND,"E011", "존재하지 않는 관심 건강 카테고리 정보입니다.");
